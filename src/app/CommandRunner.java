...
import static app.Admin.addUser;
...
public class CommandRunner {
    ...
    public static ObjectNode addUsers(CommandInput commandInput) {
        String message = Admin.addUser(commandInput.getUsername(), commandInput.getAge(), commandInput.getCity(), commandInput.getType());
    ...
    public static ObjectNode addAlbums(CommandInput commandInput) {
        User user = Admin.getUser(commandInput.getUsername());
        String message;
        if (user != null) {
